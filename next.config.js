...
module.exports = {
  ...
  eslint: {
    ...
    dirs: [
      ...
      "pages/api/combined",
      "/pages/FavoritesPage.jsx", "/pages/index.jsx", "/components/Context/Favorites-context.js", "/components/Cards/RecipeCard.jsx", "/components/LayOuts/Header/Navigation.jsx",
    ],
  },
  webpack: (config, { dev }) => {
    if (dev) {
